...
class ProxyTest {
    ...
    void proxy_lazy_with_hibernate_initialize() {
        User u = new User("proxy+" + System.currentTimeMillis() + "@ktb.api", "Pa$$w0rd!", "ProxyUser"); // ← 3-args
        em.persist(u);
    ...
    void proxy_lazy_origin_jpa_getter() {
        User u = new User("proxy2+" + System.currentTimeMillis() + "@ktb.api", "Pa$$w0rd!", "ProxyUser2"); // ← 3-args
        em.persist(u);
